! function(n, e) {
    "object" == typeof exports && "object" == typeof module ? module.exports = e() : "function" == typeof define && define.amd ? define("zoid", [], e) : "object" == typeof exports ? exports.zoid = e() : n.zoid = e()
    ...
    return function(n) {
        ...
        r.r(e), r.d(e, "PopupOpenError", (function() {
            return Mn
        ...
        var w = function() {
            ...
            return e.resolve = function(n) {
                ...
                if (!this.dispatching && (e || r)) {
                    ...
                    for (var o = function(n, e) {
                        ...
                        if (f instanceof n && (f.resolved || f.rejected)) {
                            var w = f;
                            w.resolved ? d.resolve(w.value) : d.reject(w.error), w.errorHandled = !0
                        } else a(f) ? f instanceof n && (f.resolved || f.rejected) ? f.resolved ? d.resolve(f.value) : d.reject(f.error) : o(f, d) : d.resolve(f)
                    }
                ...
                return e instanceof n ? e : a(e) ? new n((function(n, r) {
                    return e.then(n, r)
                })) : (new n).resolve(e)
            }, n.reject = function(e) {
        ...
        function _(n) {
            if (void 0 === n && (n = window), n && !E(n)) try {
                return n.opener
            } catch (n) {}
        }
        ...
        function M(n) {
            return void 0 === n && (n = window), _(n = n || window) || E(n) || void 0
        }
        ...
        function J(n) {
            return n.match(/^(https?|mock|file):\/\//) ? n.split("/").slice(0, 3).join("/") : O()
        }
        ...
        function H(n, e, r, t) {
            ...
            return void 0 === r && (r = 1e3), void 0 === t && (t = 1 / 0),
                function i() {
                    if (k(n)) return o && clearTimeout(o), e();
        ...
        function Z(n) {
            if (0 !== J(n).indexOf("mock:")) return n;
            throw new Error("Mock urls not supported out of test mode")
        }

        function G(n) {
            if (C(n)) return W(n).frameElement;
        ...
        function V(n) {
            if (function(n) {
                    return void 0 === n && (n = window), Boolean(E(n))
                }(n)) {
                var e = G(n);
        ...
        var $, K = function() {
            ...
            return e._cleanupClosedWindows = function() {
                ...
                var i = this.keys,
                    a = this.values,
                    u = X(i, n); - 1 === u ? (i.push(n), a.push(e)) : a[u] = e
            }, e.get = function(n) {
                if (!n) throw new Error("WeakMap expected key");
                var e = this.weakmap;
                if (e) try {
                ...
                this._cleanupClosedWindows();
                var t = this.keys,
                    o = X(t, n); - 1 !== o && (t.splice(o, 1), this.values.splice(o, 1))
            }, e.has = function(n) {
                if (!n) throw new Error("WeakMap expected key");
                var e = this.weakmap;
                if (e) try {
                ...
                return this._cleanupClosedWindows(), -1 !== X(this.keys, n)
        ...
        function en(n, e, r) {
            return (en = nn() ? Reflect.construct : function(n, e, r) {
                var o = [null];
                o.push.apply(o, e);
        ...
        function rn(n) {
            ...
            return (rn = function(n) {
                ...
                function r() {
                    return en(n, arguments, Q(this).constructor)
                }
        ...
        function un() {
            ...
            })) + "_" + an((new Date).toISOString().slice(11, 19).replace("T", ".")).replace(/[^a-zA-Z0-9]/g, "").toLowerCase()
        }
            ...
            try {
                return JSON.stringify([].slice.call(n), (function(n, e) {
                    return "function" == typeof e ? "memoize[" + function(n) {
                        if ($ = $ || new K, null == n || "object" != typeof n && "function" != typeof n) throw new Error("Invalid object");
                        var e = $.get(n);
                        return e || (e = typeof n + ":" + un(), $.set(n, e)), e
                    }(e) + "]" : e
                }))
            } catch (n) {
        ...
        function ln(n, e) {
            ...
            var c = function() {
                ...
                var s;
                u < fn && (r = null, t = null, u = dn, dn += 1), s = i ? (t = t || new K).getOrSet(this, sn) : r = r || {};
                var d = cn(o),
                    f = s[d];
        ...
        function hn(n) {
            ...
            function r() {
                for (var r = arguments, t = this, o = arguments.length, i = new Array(o), a = 0; a < o; a++) i[a] = arguments[a];
                var u = cn(i);
                return e.hasOwnProperty(u) || (e[u] = w.try((function() {
                    return n.apply(t, r)
                })).finally((function() {
                    delete e[u]
                }))), e[u]
        ...
        function On(n) {
            var e, r = [],
                ...
                o = {
                    set: function(e, r) {
                        return t || (n[e] = r, o.register((function() {
                            delete n[e]
                        }))), r
                    },
                    register: function(n) {
                        ...
                        return t ? n(e) : r.push(o), {
                            cancel: function() {
                                var n = r.indexOf(o); - 1 !== n && r.splice(n, 1)
                            }
                        }
                    },
                    all: function(n) {
        ...
        function An(n, e) {
            return void 0 === e && (e = {}), e && Object.keys(e).length ? (void 0 === (r = i({}, Tn(n), e)) && (r = {}), Object.keys(r).filter((function(n) {
        ...
        function In(n, e) {
            return void 0 === e && (e = document), kn(n) ? n : "string" == typeof n ? e.querySelector(n) : void 0
        }
        ...
        function zn(n) {
            return new w((function(e, r) {
                var t = vn(n),
                    o = In(n);
                if (o) return e(o);
                if (Dn()) return r(new Error("Document is ready and element " + t + " does not exist"));
                var i = setInterval((function() {
                    return (o = In(n)) ? (e(o), void clearInterval(i)) : Dn() ? (clearInterval(i), r(new Error("Document is ready and element " + t + " does not exist"))) : void 0
                }), 10)
            }))
        }
        ln((function() {
            return new w((function(n) {
                ...
                var e = setInterval((function() {
                    if (Dn() || Nn()) return clearInterval(e), n()
                }), 10)
            }))
        }));
        var Fn, Mn = function(n) {
            function e() {
                    ...
                    (function(n) {
                        if (function() {
                                for (var n = 0; n < A.length; n++) {
                                    ...
                                    e && (R.splice(n, 1), A.splice(n, 1))
                                }
                            }(), n && n.contentWindow) try {
                            A.push(n.contentWindow), R.push(n)
                        } catch (n) {}
                    })(n), e(n)
        ...
        function qn(n, e) {
            ...
            var r = n.style || {},
                t = function(n, e, r) {
                    ...
                    var t, o, i, a = document.createElement(n);
                    if (e.style && yn(a.style, e.style), e.class && (a.className = e.class.join(" ")), e.id && a.setAttribute("id", e.id), e.attributes)
                        for (var u = 0, c = Object.keys(e.attributes); u < c.length; u++) {
                            var s = c[u];
                            a.setAttribute(s, e.attributes[s])
                        }
                    if (e.styleSheet && (t = a, o = e.styleSheet, void 0 === i && (i = window.document), t.styleSheet ? t.styleSheet.cssText = o : t.appendChild(i.createTextNode(o))), e.html) {
            ...
            return t.hasAttribute("id") || t.setAttribute("id", un()), Un(t), e && function(n, e) {
                void 0 === e && (e = document);
                var r = In(n, e);
                if (r) return r;
        ...
        function Gn(n, e, r) {
            ...
            return f.addEventListener("resize", v), void 0 !== f.ResizeObserver ? ((p = new f.ResizeObserver(v)).observe(n), m = bn(v, 10 * s)) : void 0 !== f.MutationObserver ? ((p = new f.MutationObserver(v)).observe(n, {
                attributes: !0,
                childList: !0,
                subtree: !0,
                characterData: !1
            }), m = bn(v, 10 * s)) : m = bn(v, s), {
                cancel: function() {
                    w = !0, p.disconnect(), window.removeEventListener("resize", v), m.cancel()
                }
            }
        }
        ...
        function re(n) {
            return "number" == typeof n ? ee(n) : Qn(n) ? n : ee(n)
        }

        function te(n, e) {
            if ("number" == typeof n) return n;
            if (Qn(n)) return parseInt(e * ne(n) / 100, 10);
            var r;
            if ("string" == typeof(r = n) && /^[0-9]+px$/.test(r)) return ne(n);
        ...
        function ae(n, e) {
            return void 0 === n && (n = "store"), void 0 === e && (e = ie), Pn(oe(), n, (function() {
                var n = e();
                return {
                    has: function(e) {
        ...
        function se() {
            var n = oe();
            return n.WINDOW_WILDCARD = n.WINDOW_WILDCARD || new ce, n.WINDOW_WILDCARD
        }

        function de(n, e) {
            return void 0 === n && (n = "store"), void 0 === e && (e = ie), ae("windowStore").getOrSet(n, (function() {
                var r = new K,
                    t = function(n) {
        ...
        function fe() {
            return ae("instance").getOrSet("instanceID", un)
        }
        ...
        var be, Ee = ((ue = {}).function = function() {}, ue.error = function(n) {
                return ge("error", {
                    message: n.message,
                    stack: n.stack,
                    code: n.code,
            ...
            }, ue.promise = function() {}, ue.regex = function(n) {
                return ge("regex", n.source)
            }, ue.date = function(n) {
                return ge("date", n.toJSON())
            }, ue.array = function(n) {
                return n
                ...
                return n
            }, ue[void 0] = function(n) {
                return ge("undefined", n)
            }, ue),
            _e = {},
            xe = ((be = {}).function = function() {
        ...
        function Oe() {
            return !!I(window).match(/MSIE|trident|edge\/12|edge\/13/i)
        }
        ...
        function Se(n) {
            var e = n.win,
                r = n.domain;
            return !(!Oe() || r && !We(r, e) || e && !Ce(e))
        }

        function De(n) {
            return "__postrobot_bridge___" + (n = n || J(n)).replace(/[^a-zA-Z0-9]+/g, "_")
        }

        function Ne() {
            return Boolean(window.name && window.name === De(O()))
        }
        var je = new w((function(n) {
        ...
        function Re(n, e, r) {
            Ae(n).resolve((function(t, o, i) {
                if (t !== n) throw new Error("Remote window does not match window");
                if (!B(o, e)) throw new Error("Remote domain " + o + " does not match domain " + e);
                r.fireAndForget(i)
            }))
        }

        function ke(n, e) {
            Ae(n).reject(e).catch(wn)
        }

        function Ie(n) {
            for (var e = n.win, r = n.name, t = n.domain, o = ae("popupWindowsByName"), i = de("popupWindowsByWin"), a = 0, u = o.keys(); a < u.length; a++) {
                var c = u[a],
                    s = o.get(c);
                s && !k(s.win) || o.del(c)
            }
            ...
            if (d.win && d.win !== e) throw new Error("Different window already linked for window: " + (r || "undefined"));
            return r && (d.name = r, o.set(r, d)), t && (d.domain = t, Te(e)), i.set(e, d), d
        }
        ...
        function ze(n) {
            ...
            e = window.open, window.open = function(n, r, t, o) {
                ...
                function(n) {
                    ...
                    e("postrobot_open_tunnel", (function(n) {
                        ...
                        return c.then((function(n) {
                            ...
                            if (c().domain !== a) throw new Error("Message origin " + a + " does not matched registered window origin " + (c().domain || "unknown"));
                            return Re(c().win, a, u.sendMessage), {
                ...
                function(n) {
                    var e = n.send;
                    oe(window).openTunnelToParent = function(n) {
                        var r = n.name,
                            t = n.source,
                            o = n.canary,
                            i = n.sendMessage,
                        ...
                        var c = function(n) {
                            var e = n.name,
                                ...
                                o = n.sendMessage;
                            ! function() {
                                for (var n = ae("tunnelWindows"), e = 0, r = n.keys(); e < r.length; e++) {
                                    var t = r[e];
                                    k(n[t].source) && n.del(t)
                                }
                            }();
                            var i = un();
                            return ae("tunnelWindows").set(i, {
                                name: e,
                                source: r,
                                canary: t,
                                sendMessage: o
                        ...
                        return e(u, "postrobot_open_tunnel", {
                            name: r,
                ...
                function(n) {
                    ...
                    w.try((function() {
                        ...
                        if (o && Se({
                                win: o
                            })) return Te(o), (n = o, de("remoteBridgeAwaiters").getOrSet(n, (function() {
                            return w.try((function() {
                                var e = z(n, De(O()));
                                if (e) return C(e) && oe(W(e)) ? e : new w((function(n) {
                                    var r, t;
                                    r = setInterval((function() {
                                        if (e && C(e) && oe(W(e))) return clearInterval(r), clearTimeout(t), n(e)
                            ...
                            return n ? window.name ? oe(W(n)).openTunnelToParent({
                                name: window.name,
                                source: window,
                                canary: function() {},
                                sendMessage: function(n) {
                                ...
                                Re(e, r, t.sendMessage)
                            })).catch((function(n) {
                                throw ke(o, n), n
                            })) : ke(o, new Error("Can not register with opener: window does not have a name")) : ke(o, new Error("Can not register with opener: no bridge found in opener"))
                        }))
                    }))
                }({
                    on: r,
        ...
        function Fe() {
            for (var n = ae("idToProxyWindow"), e = 0, r = n.keys(); e < r.length; e++) {
                var t = r[e];
        ...
        function Me(n, e) {
            var r = e.send,
                ...
                o = void 0 === t ? un() : t,
                i = n.then((function(n) {
                    if (C(n)) return W(n).name
                })),
                a = n.then((function(n) {
                    if (k(n)) throw new Error("Window is closed, can not determine type");
                    return _(n) ? m.POPUP : m.IFRAME
                }));
            i.catch(wn), a.catch(wn);
            var u = function() {
                return n.then((function(n) {
                    if (!k(n)) return C(n) ? W(n).name : i
                }))
            };
            return {
                id: o,
                ...
                setLocation: function(e, r) {
                    return void 0 === r && (r = {}), n.then((function(n) {
                        ...
                        if ("post" === i) return u().then((function(n) {
                            ...
                            ! function(n) {
                                ...
                                if (a.setAttribute("target", r), a.setAttribute("method", i), a.setAttribute("action", e), a.style.display = "none", t)
                                    for (var u = 0, c = Object.keys(t); u < c.length; u++) {
                                        var s, d = c[u],
                                            f = document.createElement("input");
                                        f.setAttribute("name", d), f.setAttribute("value", null == (s = t[d]) ? void 0 : s.toString()), a.appendChild(f)
                                    }
                                Sn().appendChild(a), a.submit(), Sn().removeChild(a)
                            }({
                                url: e,
                                target: n,
                                method: i,
                ...
                setName: function(e) {
                    return n.then((function(n) {
                        ...
                        W(n).name = e, t && t.setAttribute("name", e), i = w.resolve(e)
                    }))
                }
            }
        }
        var Ue = function() {
            function n(n) {
                ...
                this.id = void 0, this.isProxyWindow = !0, this.serializedWindow = void 0, this.actualWindow = void 0, this.actualWindowPromise = void 0, this.send = void 0, this.name = void 0, this.actualWindowPromise = new w, this.serializedWindow = t || Me(this.actualWindowPromise, {
                    send: e
                }), ae("idToProxyWindow").set(this.getID(), this), r && this.setWindow(r, {
                    send: e
                })
            }
            var e = n.prototype;
            return e.getID = function() {
                ...
                var r = e.send;
                this.actualWindow = n, this.actualWindowPromise.resolve(this.actualWindow), this.serializedWindow = Me(this.actualWindowPromise, {
                    send: r,
                    id: this.getID()
                ...
                var t = r.send;
                return Fe(), n.toProxyWindow(e, {
                    send: t
                }).serialize()
            }, n.deserialize = function(e, r) {
                var t = r.send;
                return Fe(), ae("idToProxyWindow").get(e.id) || new n({
                    serializedWindow: e,
                    send: t
                })
                ...
                var t = r.send;
                if (Fe(), n.isProxyWindow(e)) return e;
                var o = e;
                return de("winToProxyWindow").get(o) || new n({
                    win: o,
                    send: t
                })
            }, n
        ...
        function Le(n, e, r, t, o) {
            var i = de("methodStore"),
                a = ae("proxyWindowMethods");
            Ue.isProxyWindow(t) ? a.set(n, {
                val: e,
                name: r,
                domain: o,
                source: t
        ...
        function Be(n, e, r, t, o) {
            ...
            a = (i = {
                on: o.on,
                send: o.send
            }).on, u = i.send, ae("builtinListeners").getOrSet("functionCalls", (function() {
                return a("postrobot_method", {
                    ...
                    var e = n.source,
                        ...
                        i = t.name,
                        a = qe(e, o);
                    if (!a) throw new Error("Could not find method '" + i + "' with id: " + t.id + " in " + O(window));
                    var c = a.source,
                        s = a.domain,
                        d = a.val;
                    return w.try((function() {
                        if (!B(s, r)) throw new Error("Method '" + t.name + "' domain " + JSON.stringify(xn(a.domain) ? a.domain.source : a.domain) + " does not match origin " + r + " in " + O(window));
                        if (Ue.isProxyWindow(c)) return c.matchWindow(e, {
                            send: u
                        }).then((function(n) {
                            if (!n) throw new Error("Method call '" + t.name + "' failed - proxy window does not match source in " + O(window))
                        }))
                    })).then((function() {
                        return d.apply({
                            source: e,
                        ...
                        return w.try((function() {
                            ...
                            var e;
                            throw n.stack && (n.stack = "Remote call to " + i + "(" + (void 0 === (e = t.args) && (e = []), En(e).map((function(n) {
            ...
            return "string" == typeof s && "function" == typeof s.indexOf && 0 === s.indexOf("anonymous::") && (s = s.replace("anonymous::", t + "::")), Ue.isProxyWindow(n) ? (Le(c, r, s, n, e), n.awaitWindow().then((function(n) {
                Le(c, r, s, n, e)
            }))) : Le(c, r, s, n, e), ge("cross_domain_function", {
                id: c,
                name: s
            })
        }
        ...
        function Je(n, e, r, t) {
            ...
            return function(n, e) {
                ...
                return function(n, e, r, t, o) {
                    return ge("cross_domain_zalgo_promise", {
                        then: Be(n, e, (function(n, e) {
                            return r.then(n, e)
                        }), t, {
                            on: o.on,
                            send: o.send
                ...
                return Y(n) || Ue.isProxyWindow(n) ? ge("cross_domain_window", Ue.serialize(n, {
                    send: a
                })) : n
            }, o))
        }
        ...
        function He(n, e, r, t) {
            var o, i = t.send;
            return function(n, e) {
                if (void 0 === e && (e = Pe), "undefined" !== n) return JSON.parse(n, (function(n, r) {
                    if (ve(this)) return r;
                    var t, o;
                    if (ve(r) ? (t = r.__type__, o = r.__val__) : (t = ye(r), o = r), !t) return o;
                    var i = e[t] || xe[t];
                    return i ? i(o, n) : o
                }))
                        ...
                        u = function(r) {
                            function t() {
                                ...
                                return Ue.toProxyWindow(n, {
                                    ...
                                    var s = [].slice.call(u);
                                    return r.fireAndForget ? a(n, "postrobot_method", {
                                        id: o,
                                        name: i,
                                        args: s
                                    }, {
        ...
        function Ze(n, e, r, t) {
            ...
            return w.try((function() {
                ...
                return t.buffer = t.buffer || [], t.buffer.push(r), t.flush = t.flush || w.flush().then((function() {
                    ...
                    var r, a = Je(n, e, ((r = {}).__post_robot_10_0_44__ = t.buffer || [], r), {
                        on: o,
                        send: i
                    });
                    delete t.buffer;
                    for (var u = Object.keys(Ye), c = [], s = 0; s < u.length; s++) {
                        var d = u[s];
                        try {
                            Ye[d](n, a, e)
                        } catch (n) {
        ...
        function Ge(n) {
            return ae("responseListeners").get(n)
        }

        function Ve(n) {
            ae("responseListeners").del(n)
        }

        function Xe(n) {
            return ae("erroredResponseListeners").has(n)
        }
        ...
        function $e(n) {
            ...
            for (var i = 0, a = [r, se()]; i < a.length; i++) {
                var u = a[i];
                if (u) {
                    var c = o.get(u);
                    if (c) {
        ...
        function Ke(n, e, r, t) {
            ...
            return w.all([w.flush().then((function() {
                ...
                if (!a) throw new Error("No handler found for post message: " + r.name + " from " + e + " in " + window.location.protocol + "//" + window.location.host + window.location.pathname);
                if (!B(a.domain, e)) throw new Error("Request origin " + e + " does not match domain " + a.domain.toString());
                return a.handler({
                    source: n,
                    origin: e,
                    data: r.data
        ...
        function Qe(n, e, r) {
            if (!Xe(r.hash)) {
                ...
                try {
                    if (!B(t.domain, e)) throw new Error("Ack origin " + e + " does not match domain " + t.domain.toString());
        ...
        function nr(n, e, r) {
            if (!Xe(r.hash)) {
                ...
                if (!B(o.domain, e)) throw new Error("Response origin " + e + " does not match domain " + (t = o.domain, Array.isArray(t) ? "(" + t.join(" | ") + ")" : p(t) ? "RegExp(" + t.toString() + ")" : t.toString()));
                if (n !== o.win) throw new Error("Response source does not match registered window");
                Ve(r.hash), "error" === r.ack ? o.promise.reject(r.error) : "success" === r.ack && o.promise.resolve({
                    source: n,
                    origin: e,
                    data: r.data
                })
        ...
        function er(n, e) {
            ...
            if (u) {
                ...
                for (var c = 0; c < u.length; c++) {
                    ...
                    try {
                        "postrobot_message_request" === s.type ? Ke(i, a, s, {
                            on: r,
                            send: t
                        }) : "postrobot_message_response" === s.type ? nr(i, a, s) : "postrobot_message_ack" === s.type && Qe(i, a, s)
                    } catch (n) {
                        setTimeout((function() {
                            throw n
                        }), 0)
        ...
        function rr(n, e, r) {
            ...
            var t = e.window,
                ...
                i = function n(e, r) {
                    ...
                    if (Array.isArray(o)) {
                        for (var u = [], c = 0, s = o; c < s.length; c++) u.push(n({
                            name: t,
                            domain: i,
                            win: s[c]
                        }, r));
                    ...
                    if (Array.isArray(i)) {
                        for (var d = [], f = 0, l = i; f < l.length; f++) d.push(n({
                            name: t,
                            win: o,
                            domain: l[f]
                        }, r));
                    ...
                    if (o && "*" !== o || (o = se()), i = i || "*", h) throw o && i ? new Error("Request listener already exists for " + t + " on domain " + i.toString() + " for " + (o === se() ? "wildcard" : "specified") + " window") : o ? new Error("Request listener already exists for " + t + " for " + (o === se() ? "wildcard" : "specified") + " window") : i ? new Error("Request listener already exists for " + t + " on domain " + i.toString()) : new Error("Request listener already exists for " + t);
                    var w, p, m = a.getOrSet(o, (function() {
                            return {}
                        })),
                        v = Pn(m, t, (function() {
                            return {}
                        ...
                        y = i.toString();
                    return xn(i) ? (w = Pn(v, "__domain_regex__", (function() {
                        return []
                    }))).push(p = {
                        regex: i,
                        listener: r
                        ...
                        cancel: function() {
                            delete v[y], p && (w.splice(w.indexOf(p, 1)), w.length || delete v.__domain_regex__), Object.keys(v).length || delete m[t], o && !Object.keys(m).length && a.del(o)
                        }
                    }
                }({
                    name: n,
        ...
        Ye.postrobot_post_message = function(n, e, r) {
            ...
            if (!Oe() && !Ne()) throw new Error("Bridge not needed for browser");
            if (C(n)) throw new Error("Post message through bridge disabled between same domain windows");
            if (!1 !== q(window, n)) throw new Error("Can only use bridge to communicate between two different windows, not between frames");
            ! function(n, e, r) {
                var t = F(window, n),
                    o = F(n, window);
                if (!t && !o) throw new Error("Can only send messages to and from parent and popup windows");
                Ae(n).then((function(t) {
                    return t(n, e, r)
                }))
            }(n, r, e)
        }, Ye.postrobot_global = function(n, e) {
            if (!I(window).match(/MSIE|rv:11|trident|edge\/12|edge\/13/i)) throw new Error("Global messaging not needed for browser");
            if (!C(n)) throw new Error("Post message through global disabled between different domain windows");
            if (!1 !== q(window, n)) throw new Error("Can only use global to communicate between two different windows, not between frames");
            var r = oe(n);
        ...
        var tr, or = function n(e, r, t, o) {
            ...
            return w.try((function() {
                if (function(n, e, r) {
                        if (!n) throw new Error("Expected name");
                        if (r && "string" != typeof r && !Array.isArray(r) && !xn(r)) throw new TypeError("Can not send " + n + ". Expected domain " + JSON.stringify(r) + " to be a string, array, or regex");
                        if (k(e)) throw new Error("Can not send " + n + ". Target window is closed")
                    }(r, e, i), function(n, e) {
                        var r = M(e);
                        if (r) return r === n;
                        if (e === n) return !1;
                ...
                return function(n, e, r, t) {
                    ...
                    return w.try((function() {
                        return "string" == typeof e ? e : w.try((function() {
                            ...
                            if (!B(e, e)) throw new Error("Domain " + vn(e) + " does not match " + vn(e));
                            return n
                        }))
                    }))
                ...
                if (!c) {
                    ...
                    l.push(s), s.catch((function() {
                        ! function(n) {
                            ae("erroredResponseListeners").set(n, !0)
                        }(d), Ve(d)
                    }));
                    var h = function(n) {
        ...
        function ar(n) {
            for (var e = 0, r = de("requestPromises").get(n, []); e < r.length; e++) r[e].reject(new Error("Window " + (k(n) ? "closed" : "cleaned up") + " before response")).catch(wn)
        }

        function ur(n) {
            if (!C(n)) throw new Error("Can not get global for window on different domain");
            return n.__zoid_9_0_85__ || (n.__zoid_9_0_85__ = {}), n.__zoid_9_0_85__
        }
        ...
        function lr(n) {
            var e, r, t = n.data,
                ...
                d = void 0 !== s && s,
                f = ir(a.win),
                l = d ? JSON.stringify(t) : Je(f, a.domain, t, {
                    on: rr,
                    send: or
                }),
                h = c ? (e = l, r = un(), fr(window)[r] = e, {
                    type: "uid",
                    uid: r
                }) : function(n) {
                    return {
            ...
            return {
                ...
                cleanReference: function() {
                    var n, e;
                    n = window, "uid" === (e = h).type && delete fr(n)[e.uid]
                }
            }
        }
        ...
        function hr(n) {
            var e, r, t = n.sender,
                ...
                u = a.reference,
                c = a.metaData;
            e = "function" == typeof t.win ? t.win({
                metaData: c
            }) : t.win, r = "function" == typeof t.domain ? t.domain({
                metaData: c
            }) : "string" == typeof t.domain ? t.domain : a.sender.domain;
            var s = function(n, e) {
                if ("raw" === e.type) return e.val;
                if ("uid" === e.type) return fr(n)[e.uid];
                throw new Error("Unsupported ref type: " + e.type)
            }(e, u);
            return {
                data: i ? JSON.parse(s) : function(n, e, r) {
                    return He(n, e, r, {
                        on: rr,
                        send: or
                    })
        ...
        tr = {
            ...
            openBridge: function(n, e) {
                var r = ae("bridges"),
                    t = ae("bridgeFrames");
                return e = e || J(n), r.getOrSet(e, (function() {
                    return w.try((function() {
                        if (O() === e) throw new Error("Can not open bridge on the same domain as current domain: " + e);
                        var r = De(e);
                        if (z(window, r)) throw new Error("Frame with name " + r + " already exists on page");
                        var o = function(n, e) {
            ...
            isBridge: Ne,
            needsBridge: Se,
            needsBridgeForBrowser: Oe,
            hasBridge: function(n, e) {
                return ae("bridges").has(e || J(n))
            },
            needsBridgeForWin: Ce,
            needsBridgeForDomain: We,
            destroyBridges: function() {
                for (var n = ae("bridges"), e = ae("bridgeFrames"), r = 0, t = e.keys(); r < t.length; r++) {
                    var o = e.get(t[r]);
        ...
        var br = ln((function(n) {
            var e = hr({
                data: gr(n).serializedInitialPayload,
                sender: {
                    win: function(n) {
                        return function(n) {
                            if ("opener" === n.type) return Cn("opener", _(window));
                            if ("parent" === n.type && "number" == typeof n.distance) return Cn("parent", (e = window, void 0 === (r = n.distance) && (r = 1), function(n, e) {
                                void 0 === e && (e = 1);
                            ...
                            if ("global" === n.type && n.uid && "string" == typeof n.uid) {
                                var t = function() {
                                    ...
                                    for (var t = 0, o = T(r); t < o.length; t++) {
                                        var i = o[t];
                                        if (C(i)) {
                                            var a = cr(i, (function(n) {
                                ...
                                var o = n.name;
                                return Cn("namedWindow", function(n, e) {
                                    return z(n, e) || function n(e, r) {
                                        var t = z(e, r);
                                        if (t) return t;
        ...
        function Er() {
            return br(window.name)
        }

        function _r(n, e) {
            if (void 0 === e && (e = window), n === E(e)) return {
                type: "parent",
                distance: L(n)
            };
            if (n === _(e)) return {
        ...
        function Dr(n, e, r) {
            var t = {};
            return w.all(function(n, e, o) {
                var i = [];
                return Sr(n, e, (function(n, e, o) {
                            ...
                            if (null != o) {
                                ...
                                if (u) return w.hash({
                                    ...
                                    finalValue: w.try((function() {
                                        return "function" == typeof c && _n(o) ? c({
                                            value: o
                                        }) : o
                                    }))
                                }).then((function(r) {
                                    var o, i = r.finalParam,
                                        a = r.finalValue;
                                    if ("boolean" == typeof a) o = a.toString();
                                    else if ("string" == typeof a) o = a.toString();
                                    else if ("object" == typeof a && null !== a) {
                                        if (e.serialization === pr.JSON) o = JSON.stringify(a);
                                        else if (e.serialization === pr.BASE64) o = an(JSON.stringify(a));
                                        else if (e.serialization === pr.DOTIFY || !e.serialization) {
                                            o = function n(e, r, t) {
        ...
        function Nr(n) {
            var e, r, t, o, a, u, c, s = n.uid,
                    ...
                    trigger: function(n) {
                        ...
                        if (i)
                            for (var u = function(n) {
                                    var e = i[n];
                                    a.push(w.try((function() {
                                        return e.apply(void 0, t)
                                    })))
                                }, c = 0; c < i.length; c++) u(c);
                        return w.all(a).then(wn)
                    },
                ...
                Q = l.setProxyWin,
                nn = l.openFrame,
                en = l.openPrerenderFrame,
                rn = l.prerender,
                tn = l.open,
                on = l.openPrerender,
                an = l.watchForUnload,
                cn = l.getInternalState,
                sn = l.setInternalState,
                dn = function() {
                ...
                fn = function() {
                    return w.try((function() {
                        return l.resolveInitPromise ? l.resolveInitPromise() : N.resolve()
                    }))
                },
                hn = function(n) {
                    return w.try((function() {
                        return l.rejectInitPromise ? l.rejectInitPromise(n) : N.reject(n)
                    }))
                },
                gn = function(n) {
                    for (var e = {}, r = 0, t = Object.keys(z); r < t.length; r++) {
                        var o = t[r],
                            i = m[o];
                        i && !1 === i.sendToChild || i && i.sameDomain && !B(n, O(window)) || (e[o] = z[o])
                    }
                    return w.hash(e)
                },
                xn = function() {
                ...
                Pn = function(n) {
                    return w.try((function() {
                        return sn ? sn(n) : R = i({}, R, n)
                    }))
                },
                Cn = function() {
                    return K ? K() : w.try((function() {
                        var n = z.window;
                        if (n) {
                            var e = ir(n);
                ...
                Wn = function(n) {
                    return U ? U(n) : w.try((function() {
                        return zn(n)
                    })).then((function(n) {
                        return Vn(n) && (n = function n(e) {
                            var r = function(n) {
                                var e = function(n) {
                                    for (; n.parentNode;) n = n.parentNode;
                                    if (Vn(n)) return n
                            ...
                            var t = "shadow-slot-" + un(),
                                o = document.createElement("slot");
                            o.setAttribute("name", t), e.appendChild(o);
                            var i = document.createElement("div");
                            return i.setAttribute("slot", t), r.appendChild(i), Vn(r) ? n(i) : i
                        }(n)), sr(n)
                    }))
                },
                Sn = function(n) {
                ...
                Un = function(n) {
                    return en ? en(n) : w.try((function() {
                        if (n === mr.IFRAME) return sr(qn({
                            attributes: i({
                                name: "__zoid_prerender_frame__" + b + "_" + un() + "__",
                                title: "prerender__" + b
                            }, Tn().iframe)
                        }))
                    }))
                ...
                Xn = function(n, e, r) {
                    return on ? on(n, e, r) : w.try((function() {
                        if (n === mr.IFRAME) {
                        ...
                        if (n === mr.POPUP) return e;
                        throw new Error("No render context available for " + n)
                    }))
                },
                $n = function() {
                    return w.try((function() {
                        if (o) return w.all([I.trigger(vr.FOCUS), o.focus()]).then(wn)
                    }))
                },
                Kn = function(n, e, r, t) {
                    if (e === O(window)) return {
                        type: "global",
                        uid: (o = ur(window), o.windows = o.windows || {}, o.windows[s] = window, T.register((function() {
                            delete o.windows[s]
                        })), s)
                    };
                    var o;
                    ...
                    if (z.window) {
                        ...
                        if (M(i) !== window) throw new Error("Can not construct cross-domain window reference for window prop with different ancestor")
                    }
                    if (r === mr.POPUP) return {
                        type: "opener"
                    };
                    if (r === mr.IFRAME) return {
                        type: "parent",
                        distance: L(window)
                    };
                ...
                Qn = function(n, e) {
                    return w.try((function() {
                        c = n, u = e, fn(), T.register((function() {
                            return e.close.fireAndForget().catch(wn)
                        }))
                    }))
                },
                ne = function(n) {
                ...
                ee = function(n) {
                    return w.try((function() {
                        ...
                        N.asyncReject(n || new Error("Component destroyed"))
                    }))
                },
                re = ln((function(n) {
                    return w.try((function() {
                        ...
                        return w.try((function() {
                            ...
                            return ee(n || new Error("Component closed"))
                        }))
                    }))
                })),
                oe = function(n, e) {
                    ...
                    return tn ? tn(n, {
                        ...
                        if (n === mr.POPUP) {
                            var e = dn(),
                                ...
                                u = e.height,
                                c = void 0 === u ? "150px" : u;
                            a = te(a, window.outerWidth), c = te(c, window.outerWidth);
                            var s = function(n, e) {
                                var r = (e = e || {}).closeOnUnload,
                                    ...
                                    s = 0,
                                    d = 0;
                                u && (window.outerWidth ? d = Math.round((window.outerWidth - u) / 2) + window.screenX : window.screen.width && (d = Math.round((window.screen.width - u) / 2))), c && (window.outerHeight ? s = Math.round((window.outerHeight - c) / 2) + window.screenY : window.screen.height && (s = Math.round((window.screen.height - c) / 2))), delete e.closeOnUnload, delete e.name, u && c && (e = i({
                                    top: s,
                                    left: d,
                                    width: u,
                                    height: c,
                                ...
                                var f, l, h = Object.keys(e).map((function(n) {
                                    if (null != e[n]) return n + "=" + vn(e[n])
                                })).filter(Boolean).join(",");
                                try {
                                    f = window.open("", a, h)
                                } catch (l) {
                                    throw new Mn("Can not open popup window - " + (l.stack || l.message))
                                }
                                if (k(f)) throw new Mn("Can not open popup window - blocked");
                                return t && window.addEventListener("unload", (function() {
                                    return f.close()
                                })), f
                            }(0, i({
                                name: o,
                ...
                ie = function() {
                    return w.try((function() {
                        var n = Bn(window, "unload", pn((function() {
                                ee(new Error("Window navigated away"))
                            }))),
                            e = H(p, ee, 3e3);
                        if (T.register(e.cancel), T.register(n.cancel), an) return an()
                    }))
                },
                ae = function(n) {
                    var e = !1;
                    return n.isClosed().then((function(r) {
                        return r ? (e = !0, re(new Error("Detected component window close"))) : w.delay(200).then((function() {
                            return n.isClosed()
                        })).then((function(n) {
                            if (n) return e = !0, re(new Error("Detected component window close"))
                        }))
                    })).then((function() {
                        return e
                    }))
                ...
                ue = function(n) {
                    return F ? F(n) : w.try((function() {
                        if (-1 === j.indexOf(n)) return j.push(n), N.asyncReject(n), I.trigger(vr.ERROR, n)
                    }))
                },
                ce = new w,
                se = function(n) {
            ...
            var de = function(n, e) {
                    ...
                    return rn ? rn(n, {
                        ...
                        if (y) {
                            ...
                            if (e && C(e) && function(n) {
                                ...
                                var t = (e = W(e)).document,
                                    o = de(y, {
                                        context: r,
                                        doc: t
                                    });
                                if (o) {
                                    if (o.ownerDocument !== t) throw new Error("Expected prerender template to have been created with document from child window");
                                    ! function(n, e) {
                                        var r = e.tagName.toLowerCase();
                                        if ("html" !== r) throw new Error("Expected element to be html, got " + r);
                                        for (var t = n.document.documentElement, o = 0, i = En(t.children); o < i.length; o++) t.removeChild(i[o]);
                                        for (var a = 0, u = En(e.children); a < u.length; a++) t.appendChild(u[a])
                                    }(e, o);
                                    var i = x.width,
                                        a = void 0 !== i && i,
                                        u = x.height,
                            ...
                            var u = function(n, e) {
                                ...
                                var r, t, o, i = !1,
                                    ...
                                    u = function() {
                                        ...
                                        r && r.cancel(), o && o.removeEventListener("unload", c), t && Yn(t)
                                    },
                                    c = function() {
                                        i || (e(), u())
                                    };
                                ...
                                return (t = document.createElement("iframe")).setAttribute("name", "__detect_close_" + un() + "__"), t.style.display = "none", Ln(t).then((function(n) {
                                    (o = W(n)).addEventListener("unload", c)
                                })), n.appendChild(t), r = bn((function() {
                                    Zn(n) && c()
                                }), 1e3), {
                                    cancel: u
                                }
                                ...
                                return w.delay(1).then((function() {
                                    if (!Zn(t)) return T.all(n), i().then(fn, hn);
                                    re(n)
                                }))
                            }));
                            return T.register((function() {
                ...
                we = function(n, e) {
                    ...
                    var r = he();
                    ! function(n, e, r, t, o) {
                        void 0 === o && (o = !1), yn(e, r = r || {});
                        for (var i = o ? [] : [].concat(Object.keys(n)), a = 0, u = Object.keys(r); a < u.length; a++) {
                            var c = u[a]; - 1 === i.indexOf(c) && i.push(c)
                        }
                        for (var s = [], d = t.state, f = t.close, l = t.focus, h = t.event, w = t.onError, p = 0; p < i.length; p++) {
                            var m = i[p],
                                v = n[m],
                                y = r[m];
                            if (v) {
                                var g = v.alias;
                                if (g && (!_n(y) && _n(r[g]) && (y = r[g]), s.push(g)), v.value && (y = v.value({
                                        props: e,
                                        state: d,
                                        close: f,
                                        focus: l,
                                        ...
                                        event: h,
                                        onError: w
                                    })), _n(y) && ("array" === v.type ? !Array.isArray(y) : typeof y !== v.type)) throw new TypeError("Prop is not of type " + v.type + ": " + m);
                                e[m] = y
                            }
                        }
                        for (var b = 0; b < s.length; b++) delete e[s[b]];
                        Sr(e, n, (function(n, r, t) {
                            if (r && _n(t) && r.decorate) {
                                var o = r.decorate({
                                    value: t,
                                    props: e,
                                    state: d,
                        ...
                        for (var E = 0, _ = Object.keys(n); E < _.length; E++) {
                            var x = _[E];
                            if (!1 !== n[x].required && !_n(e[x])) throw new Error('Expected prop "' + x + '" to be defined')
                        }
                    }(m, z, n, r, e)
                },
                pe = function(n) {
                    return we(n, !0), N.then((function() {
                        var n = u,
                            e = o;
                        if (n && e && c) return gn(c).then((function(r) {
            ...
            return {
                init: function() {
                    I.on(vr.RENDER, (function() {
                        ...
                        return z && z.onError ? z.onError(n) : hn(n).then((function() {
                            setTimeout((function() {
                                throw n
                            }), 1)
                        }))
                ...
                render: function(n) {
                    ...
                    return w.try((function() {
                        ...
                        ! function(n, e, r) {
                            if (n !== window) {
                                if (!q(window, n)) throw new Error("Can only renderTo an adjacent frame");
                                var t = O();
                                if (!B(e, t) && !C(n)) throw new Error("Can not render remotely to " + e.toString() + " - can only render to " + t);
                        ...
                        var u = w.try((function() {
                                if (e !== window) return function(n, e) {
                                    ...
                                    var u = or(e, "zoid_delegate_" + b, {
                                        ...
                                        overrides: {
                                            ...
                                            getInternalState: xn,
                                            setInternalState: Pn,
                                            resolveInitPromise: fn,
                                            rejectInitPromise: hn
                                        }
                                    }).then((function(n) {
                                        var r = n.data.parent;
                                        return T.register((function(n) {
                                            if (!k(e)) return r.destroy(n)
                                ...
                                return function(n) {
                                    ...
                                    return function(n) {
                                        var e = void 0 === n ? {} : n,
                                            ...
                                            o = e.context;
                                        return gn(e.initialChildDomain).then((function(n) {
                                            return {
                                                uid: s,
                                                context: o,
                                                tag: g,
                            ...
                            D = w.hash({
                                ...
                                return Xn(t, n.proxyWin, n.proxyPrerenderFrame)
                            })),
                            j = W.then((function(n) {
                                return o = n, Sn(n)
                            })),
                            ...
                            F = w.hash({
                                ...
                                return d.method ? d.method : Object.keys(n.body).length ? "post" : "get"
                            })),
                            M = w.hash({
                                proxyWin: W,
                                windowUrl: l,
                            ...
                            L = W.then((function(n) {
                                ! function n(e, r) {
                                    ...
                                    return T.register((function() {
                                        ...
                                        if (!t) return o ? re(new Error("Detected " + r + " close")) : n(e, r)
                                    }))
                                }(n, t)
                            })),
                            H = w.hash({
                            ...
                            V = W.then((function(e) {
                                return function(n, e, r) {
                                    return w.try((function() {
                                        ...
                                        if (tr && tr.needsBridge({
                                                win: n,
                                                domain: e
                                            }) && !tr.hasBridge(e, e)) {
                                            var t = "function" == typeof d.bridgeUrl ? d.bridgeUrl({
                                                props: z
                                            }) : d.bridgeUrl;
                                            if (!t) throw new Error("Bridge needed to render " + r);
                                            var o = J(t);
                                            return tr.linkUrl(n, e), tr.openBridge(Z(t), o)
                                        }
                                    }))
                                }(e, n, t)
                            })),
                            X = M.then((function() {
                                return w.try((function() {
                                    var n = z.timeout;
                                    if (n) return N.timeout(n, new Error("Loading component timed out after " + n + " milliseconds"))
                                }))
                            })),
                            un = N.then((function() {
                        ...
                        return w.hash({
                            ...
                            openBridgePromise: V,
                            runTimeoutPromise: X,
                            onRenderedPromise: un,
                            delegatePromise: u,
                            watchForUnloadPromise: f
                        })
                    })).catch((function(n) {
                        return w.all([ue(n), ee(n)]).then((function() {
                            throw n
                        }), (function() {
                            throw n
                        }))
        ...
        function jr(n) {
            ...
            if (r && t) {
                ...
                return i.cspNonce && f.setAttribute("nonce", i.cspNonce), f.appendChild(o.createTextNode("\n            #" + e + " {\n                display: inline-block;\n                position: relative;\n                width: " + c + ";\n                height: " + s + ";\n            }\n\n            #" + e + " > iframe {\n                display: inline-block;\n                position: absolute;\n                width: 100%;\n                height: 100%;\n                top: 0;\n                left: 0;\n                transition: opacity .2s ease-in-out;\n            }\n\n            #" + e + " > iframe.zoid-invisible {\n                opacity: 0;\n            }\n\n            #" + e + " > iframe.zoid-visible {\n                opacity: 1;\n        }\n        ")), d.appendChild(r), d.appendChild(t), d.appendChild(f), t.classList.add("zoid-visible"), r.classList.add("zoid-invisible"), a.on(vr.RENDERED, (function() {
                    ...
                    var e = n.width,
                        r = n.height;
                    "number" == typeof e && (d.style.width = re(e)), "number" == typeof r && (d.style.height = re(r))
                })), d
            }
        }
        ...
        function Tr(n) {
            ...
            return a.classList.add("spinner"), r.cspNonce && i.setAttribute("nonce", r.cspNonce), t.appendChild(o), o.appendChild(a), o.appendChild(i), i.appendChild(e.createTextNode("\n            html, body {\n                width: 100%;\n                height: 100%;\n            }\n\n            .spinner {\n                position: fixed;\n                max-height: 60vmin;\n                max-width: 60vmin;\n                height: 40px;\n                width: 40px;\n                top: 50%;\n                left: 50%;\n                box-sizing: border-box;\n                border: 3px solid rgba(0, 0, 0, .2);\n                border-top-color: rgba(33, 128, 192, 0.8);\n                border-radius: 100%;\n                animation: rotation .7s infinite linear;\n            }\n\n            @keyframes rotation {\n                from {\n                    transform: translateX(-50%) translateY(-50%) rotate(0deg);\n                }\n                to {\n                    transform: translateX(-50%) translateY(-50%) rotate(359deg);\n                }\n            }\n        ")), t
        }
        var Ar = On(),
            Rr = On();
        ...
        function kr(n) {
            var e, r, t = function(n) {
                    var e = n.tag,
                        ...
                        R = i({}, {
                            window: {
                                ...
                                validate: function(n) {
                                    var e = n.value;
                                    if (!Y(e) && !Ue.isProxyWindow(e)) throw new Error("Expected Window or ProxyWindow");
                                    if (Y(e)) {
                    ...
                    return {
                        ...
                        eligible: P,
                        children: T,
                        exports: "function" == typeof D ? D : function(n) {
                            for (var e = n.getExports, r = {}, t = function(n, t) {
                                    var o = t[n],
                                        i = D[o].type,
                                        a = e().then((function(n) {
                                            return n[o]
                                        }));
                                    r[o] = i === wr.FUNCTION ? function() {
                                        for (var n = arguments.length, e = new Array(n), r = 0; r < n; r++) e[r] = arguments[r];
                                        return a.then((function(n) {
                                            return n.apply(void 0, e)
                                        }))
                                    } : a
                                }, o = 0, i = Object.keys(D); o < i.length; o++) t(o, i);
                            return r
                        }
                    }
                }(n),
                ...
                l = function() {
                    if (function(n) {
                            try {
                                return gr(window.name).name === n
                            } catch (n) {}
                            return !1
                        }(o)) {
                        var n = Er().payload;
                        if (n.tag === a && B(n.childDomainMatch, O())) return !0
                    }
                    return !1
                },
                h = ln((function() {
                    if (l()) {
                        ...
                        var n = function(n) {
                            var e, r = n.tag,
                                ...
                                v = s.context,
                                y = s.props;
                            if ("9_0_85" !== h) throw new Error("Parent window has zoid version " + h + ", child window has version 9_0_85");
                            var g = m.show,
                                b = m.hide,
                                E = m.close,
                                _ = m.onError,
                                ...
                                I = function(n) {
                                    ...
                                    for (var a = 0, u = T(window); a < u.length; a++) {
                                        var c = u[a];
                                        if (C(c)) {
                                            var s = W(c).xprops;
                                            if (s && N() === s.getParent()) {
                                ...
                                z = function(n, o, i) {
                                    ...
                                    var u = function(n, e, r, t, o, i) {
                                        ...
                                        for (var a = {}, u = 0, c = Object.keys(r); u < c.length; u++) {
                                            var s = c[u],
                                                d = e[s];
                                            if (!d || !d.sameDomain || t === O(window) && C(n)) {
                                                var f = xr(e, 0, s, r[s], o);
                                                a[s] = f, d && d.alias && !a[d.alias] && (a[d.alias] = f)
                                            }
                                        }
                                        if (!i)
                                            for (var l = 0, h = Object.keys(e); l < h.length; l++) {
                                                var w = h[l];
                                                r.hasOwnProperty(w) || (a[w] = xr(e, 0, w, void 0, o))
                                            }
                                        return a
                                    }(d, t, n, o, {
                                        tag: r,
                                ...
                                init: function() {
                                    return w.try((function() {
                                        return C(d) && function(n) {
                                            ...
                                            }), ur(window).exports = n.exports({
                                                getExports: function() {
                                                    return l
                                                }
                                            }),
                                            function(n, e) {
                                                if (!B(n, e)) throw new Error("Can not be rendered by domain: " + e)
                                            }(i, f), me(d), window.addEventListener("beforeunload", (function() {
                                                x.fireAndForget()
                                        ...
                                        return (n = o.width, e = void 0 !== n && n, r = o.height, t = void 0 !== r && r, i = o.element, zn(void 0 === i ? "body" : i).catch(wn).then((function(n) {
                                            return {
                                                width: e,
                                                height: t,
                                                element: n
                                            ...
                                            var e = n.width,
                                                r = n.height,
                                                t = n.element;
                                            t && (e || r) && v !== mr.POPUP && Gn(t, (function(n) {
                                                R({
            ...
            if (h(), e = rr("zoid_allow_delegate_" + o, (function() {
                    return !0
                })), r = rr("zoid_delegate_" + o, (function(n) {
                    var e = n.data;
                    return {
                        parent: Nr({
                            uid: e.uid,
                ...
                })), Rr.register(e.cancel), Rr.register(r.cancel), d.components = d.components || {}, d.components[a]) throw new Error("Can not register multiple components with the same tag: " + a);
            return d.components[a] = !0, {
                init: function n(e) {
                    ...
                    l.onDestroy = function() {
                        if (r && p && f.splice(f.indexOf(r), 1), v) return v.apply(void 0, arguments)
                    };
                    var y = Nr({
                        uid: d,
                        options: t
                    });
                    y.init(), p ? y.setProps(l) : l.onDestroy && l.onDestroy(), Ar.register((function(n) {
                        return y.destroy(n || new Error("zoid destroyed all components"))
                    }));
                    var g = function(e) {
                            var r = (void 0 === e ? {} : e).decorate;
                            return n((void 0 === r ? gn : r)(l))
                        },
                        b = function(n, e, t) {
                            return w.try((function() {
                                if (!p) {
                                    var e = new Error(m || o + " component is not eligible");
                                ...
                                return function(n, e) {
                                    return w.try((function() {
                                        if (n.window) return ir(n.window).getType();
                                        if (e) {
                                            if (e !== mr.IFRAME && e !== mr.POPUP) throw new Error("Unrecognized context: " + e);
                                            return e
                                        }
                                        return u
                                    }))
                                ...
                                if (e = function(n, e) {
                                        if (e) {
                                            if ("string" != typeof e && !kn(e)) throw new TypeError("Expected string or element selector to be passed");
                                            return e
                                        }
                                        if (n === mr.POPUP) return "body";
                                ...
                                return y.render({
                                    ...
                                    rerender: function() {
                                        var o = g();
                                        return yn(r, o), o.renderTo(n, e, t)
                                    }
                                })
                            })).catch((function(n) {
                    ...
                    return r = i({}, y.getExports(), y.getHelpers(), function() {
                        for (var n = s(), e = {}, r = function(r, t) {
                                var o = t[r],
                                    a = n[o];
                                e[o] = function(n) {
                                    var e = y.getProps(),
                            ...
                            }, t = 0, o = Object.keys(n); t < o.length; t++) r(t, o);
                        return e
                    }(), {
                        isEligible: function() {
                            return p
                ...
                canRenderTo: function(n) {
                    return or(n, "zoid_allow_delegate_" + o).then((function(n) {
                        return n.data
                    })).catch((function() {
                        return !1
                    }))
        ...
        var Ir = function(n) {
            var e, r, t, o;
            oe().initialized || (oe().initialized = !0, r = (e = {
                on: rr,
                send: or
            }).on, t = e.send, (o = oe()).receiveMessage = o.receiveMessage || function(n) {
                return er(n, {
                    on: r,
                    send: t
                })
                ...
                ae().getOrSet("postMessageListener", (function() {
                    return Bn(window, "message", (function(n) {
                        ! function(n, e) {
                            var r = e.on,
                                t = e.send;
                            w.try((function() {
        ...
        function Mr(n) {
            return Fr(), delete window.__zoid_9_0_85__,
                function() {
                    for (var n = ae("responseListeners"), e = 0, r = n.keys(); e < r.length; e++) {
                        var t = r[e],
                            o = n.get(t);
                        o && (o.cancelled = !0), n.del(t)
                    }
                }(), (e = ae().get("postMessageListener")) && e.cancel(), delete window.__post_robot_10_0_44__, Rr.all(n);
            var e
        }
    }])
}));
