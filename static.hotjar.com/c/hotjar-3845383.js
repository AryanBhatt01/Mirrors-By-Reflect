window.hjSiteSettings = window.hjSiteSettings || {
    ...
    "features": ["ask.popover_redesign", "client_script.compression.pc", "error_reporting", "feedback.embeddable_widget", "feedback.widgetV2", "feedback.widget_telemetry", "settings.billing_v2", "survey.embeddable_widget", "survey.image_question", "survey.screenshots"],
...
! function() {
    ...
    window.hjBootstrap = window.hjBootstrap || function(t, e, r) {
        ...
        d.async = 1, d.src = hj.scriptDomain + e, d.charset = "utf-8", l.appendChild(d), c.revision = "af3d1c7", window.hjBootstrap = c
    }, window.hjLazyModules = window.hjLazyModules || {
        SURVEY_V2: {
            js: "survey-v2.54415f80b0819d1c4fb3.js"
        },
        SURVEY_BOOTSTRAPPER: {
            js: "survey-bootstrapper.d0813e4b8ed492bed8b4.js"
        },
        SURVEY_ISOLATED: {
            js: "survey-isolated.2a23dd6b523703575ed3.js"
        },
        HEATMAP_RETAKER: {
            js: "heatmap-retaker.f79c0c7bb13d8a14bddc.js"
        },
        SURVEY_INVITATION: {
            js: "survey-invitation.ee6a671368f05c1d396c.js"
        },
        NOTIFICATION: {
            js: "notification.86732657079a99e6ce8a.js"
        },
        PREACT_INCOMING_FEEDBACK: {
            js: "preact-incoming-feedback.a4d7fb05a6657790bcf7.js"
        },
        SENTRY: {
    ...
    }, m ? window._uxa.push(["start:hotjar", window.hjSiteSettings]) : (window.hjBootstrap("https://script.hotjar.com/", "modules.db8890ba82a7e392473f.js", "3845383"), hj.metrics.timeEnd("resource-blocking-time", {
        tag: {
            resource: "hotjar-js"
        },
        start: w,
